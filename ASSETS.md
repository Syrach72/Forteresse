...
Le fond de la pastille de compteur des lits du Dortoir (`public/assets/references/bed-counter.webp`) est un visuel fourni par Bruno le 18 septembre 2026 (cuir noir, coins dorés), utilisé en `background` de `.dorm-named .rest-counter`. Vérifier la licence avant toute diffusion publique.
